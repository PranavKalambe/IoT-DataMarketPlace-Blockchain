            ...
            <Table striped bordered hover responsive>
              ...
              <tbody>
                {bidData.map((data) => (
                  ...
                  <tr key={data.id}>
                    <td>{data.id}</td>
                    <td>{data.location==="MUMS" ? "Temperature of Mumbai" : data.location==="SURS" ? "Temperature of Surat":"Temperature of Pune"}</td>
                    <td>{data.sensor}</td>
                    <td>{data.location}</td>
            ...
            <form>
              <table>
                ...
                <tr>
                  ...
                  <td id="top_bid">{
                  response[4] === undefined ? null : web3_inter.utils.fromWei(response[4],"ether")
                  }</td>
                </tr>
                <tr>
                  <td>Your Bid </td>
